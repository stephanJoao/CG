...
var saul = textureLoader.load('assets/download.jpg');

// Apply texture to the 'map' property of the respective materials' objects

plane.material.map = saul;
plane.material.side = THREE.DoubleSide;
plane2.material.map = saul;
plane2.material.side = THREE.DoubleSide;
plane3.material.map = saul;
plane3.material.side = THREE.DoubleSide;
plane4.material.map = saul;
plane4.material.side = THREE.DoubleSide;
plane5.material.map = saul;
