...
var cylinderA = new THREE.Mesh(cylinderGeometry2, cylinderMaterial3);
cylinder2.add(cylinderA);

var cylinderB = new THREE.Mesh(cylinderGeometry2, cylinderMaterial3);
cylinder2.add(cylinderB);
...
function rotateCylinder() {
	...
	cylinderA.matrixAutoUpdate = false;
	cylinderB.matrixAutoUpdate = false;
	...
	if (animationOn) {
		...
		cylinderA.matrix.identity();
		cylinderB.matrix.identity();
		...
		// Will execute R2, T1 and R1 in this order
		cylinderA.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0)); // T1
		cylinderA.matrix.multiply(mat4.makeRotationY(angleA)); // R1
		cylinderA.matrix.multiply(mat4.makeTranslation(0.0, 0.0, 0.0)); // T1
		cylinderA.matrix.multiply(mat4.makeRotationX(degreesToRadians(90))); // R2

		// Will execute R2, T1 and R1 in this order
		cylinderB.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0)); // T1
		cylinderB.matrix.multiply(mat4.makeRotationY(angleB)); // R1
		cylinderB.matrix.multiply(mat4.makeTranslation(0.0, 0.0, 0.0)); // T1
		cylinderB.matrix.multiply(mat4.makeRotationX(degreesToRadians(90))); // R2
	}
}
